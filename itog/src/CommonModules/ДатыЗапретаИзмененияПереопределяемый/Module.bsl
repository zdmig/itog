...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	Раздел.Представление = НСтр("ru = 'Раздел закупки'");  
	
	Раздел = Разделы.Добавить();
	Раздел.Имя  = "ЗарплатаИКадры";
	Раздел.Идентификатор = Новый УникальныйИдентификатор("ea5013a1-13f9-11ee-a63a-ac1f6bb47f49");
	Раздел.Представление = НСтр("ru = 'Зарплата и кадры'"); 
	
	Раздел = Разделы.Добавить();
	Раздел.Имя  = "Казначейство";
	Раздел.Идентификатор = Новый УникальныйИдентификатор("ea5013a1-13f9-11ee-a63a-ac1f6bb47f59");
	Раздел.Представление = НСтр("ru = 'Казначейство'"); 
	
	Раздел = Разделы.Добавить();
	Раздел.Имя  = "Продажи";
	Раздел.Идентификатор = Новый УникальныйИдентификатор("ea5013a1-13f9-11ee-a63a-ac1f6bb47f69");
	Раздел.Представление = НСтр("ru = 'Раздел продажи'"); 
...
ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ЗаказПоставщику", "Дата", "Закупки");
ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.УстановкаЦенНоменклатуры", "Дата", "Казначейство");
ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ЗаказКлиента", "Дата", "Продажи");
ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПриходныйКассовыйОрдер", "Дата", "Казначейство");
ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.РасходныйКассовыйОрдер", "Дата", "Казначейство");
ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПоступлениеНаРасчетныйСчет", "Дата", "Казначейство");
ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.СписаниеСРасчетногоСчета", "Дата", "Казначейство");
ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ВозвратОтКлиента", "Дата", "Закупки");
ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.УстановкаОкладов", "Дата", "ЗарплатаИКадры");
ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.НачислениеЗарплаты", "Дата", "ЗарплатаИКадры");
ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПоступлениеТоваров", "Дата", "Продажи");
ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.РеализацияТоваров", "Дата", "Продажи");
